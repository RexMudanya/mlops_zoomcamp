...
def run_train(data_path: str):
    ...
    mlflow.set_experiment("RFR Hwrk")
    with mlflow.start_run():
        ...
        rf = RandomForestRegressor(max_depth=params["max_depth"], random_state=params["random_state"])
        rf.fit(X_train, y_train)
        y_pred = rf.predict(X_val)
        
        mlflow.sklearn.log_model(rf, "rfr_model")
