...
def calculate_metrics_postgresql(curr, i):
	...
	col_quantile_metric =  result['metrics'][3]['result']['current']['value']
	...
	curr.execute(
		...
		(begin + datetime.timedelta(i), prediction_drift, num_drifted_columns, share_missing_values, col_quantile_metric)
	)
